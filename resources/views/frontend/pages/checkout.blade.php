        ...
        <div class="cart-items" style="min-height:800px">
            <div class="container">
                ...
                <div class="cart-header wow fadeInUp animated" data-wow-delay=".5s">
                    ...
                    <div class="cart-sec simpleCart_shelfItem">
                        ...
                        <div class="cart-item-info">
                            <h4><a href="#"> {{ $orderDetail->product->product_title }} </a><span>Pickup time : Next Day</span></h4>
                            <ul class="qty">
                                <li><p>Minimum order : 500 tk</p></li>
                                <li><p>Delivery Charge: 50 tk</p></li>
                            </ul>
                            <div class="delivery">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <form method="POST" action="{{ url('checkoutStore') }}" id="checkoutPage{{ $orderDetail->id }}">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{ $orderDetail->id }}">
                            <select class="form-control" onchange="document.getElementById('checkoutPage{{ $orderDetail->id }}').submit();" name="quantity" id="quantity">
                                ...
                                <div class="col-md-1"> 
                                    <a href="#" title="Delete"
                                       onclick=" document.getElementById('deleteFormPage{{ $orderDetail->id }}').submit();  event.returnValue = false; return false;">
                                        <img class="remove-icon" src="{{ asset('frontend/images/remove.png') }}" alt="">
                                    </a>
                                    <form method="POST" action="{{ URL('orderDestroy') }}" id="deleteFormPage{{ $orderDetail->id }}">
                                        {{ csrf_field() }}
                ...
                <div class="facebook-area">
                            <a href="{{ url('orderDetails/' . $order->order_track_id) }}" class="fb-link">Continue To Next</a>
                        </div>
                @endif
