            ...
            <div class="container">
                <div class="col-md-9 product-model-sec">
                    <ul class="nav nav-tabs">
                        <li class="<?php if ($preOrder == '' && $user == '' && $company == ''): ?> active<?php endif; ?>"><a href="{{ url('allBrandProduct/' . $product_brand_id) }}">All Products</a></li>
                        <li class="<?php if ($user == 'User'): ?> active<?php endif; ?>"><a href="{{ url('userBrandProduct/' . $product_brand_id) }}">Individual Products</a></li>
                        <li class="<?php if ($company == 'Company'): ?> active<?php endif; ?>"><a href="{{ url('companyBrandProduct/' . $product_brand_id) }}">Company Products</a></li>
                        <li class="<?php if ($preOrder == 'PreOrder'): ?> active<?php endif; ?>"><a href="{{ url('preOrderBrandProduct/' . $product_brand_id) }}">PreOrder Products</a></li>
                    </ul>
                    <span id="productDiv">
                        @if(count($dataList) > 0)
