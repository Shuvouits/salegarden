                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default" style="margin-top:20px">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/createCompany') }}">
                                {{ csrf_field() }}

                                <div class="form-group">
                                    <label for="users_name" class="col-md-4 control-label">Company Name</label>
                                ...
                                <div class="form-group">
                                    <label for="users_email" class="col-md-4 control-label">E-Mail Address</label>
                                ...
                                <div class="form-group">
                                    <label for="users_mobile" class="col-md-4 control-label">Mobile No</label>
