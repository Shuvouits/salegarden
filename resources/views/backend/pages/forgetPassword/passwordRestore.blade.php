                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('admin.password.reset') }}">
                            ...
                            <div style="margin-top: 30px">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Enter Confirm Password" required="required">
                                    </div>
                                </div>
                                <div class="form-group"> 
