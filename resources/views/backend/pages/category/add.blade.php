                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ url('portal/category/store') }}">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="category_status" name="category_status" required>
                                                <option value="">--</option>
                                                <option value="Active"@if('Active' == old('category_status')) selected="selected" @endif>Active</option>
                                                <option value="Inactive"@if('Inactive' == old('category_status')) selected="selected" @endif>Inactive</option>
                                            </select>
                                        </div>
