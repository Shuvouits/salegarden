                                                ...
                                                <div class="col-md-9">
                                                    <table style="width: 100%" class="table table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%;">{{ $companyInfo->company_info_contact_person }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width: 50%;">Contact Person Email</th>
                                                            <td style="width: 50%;">{{ $companyInfo->company_info_contact_person_email }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width: 50%;">Contact Person Mobile</th>
                                                            <td style="width: 50%;">{{ $companyInfo->company_info_contact_person_mobile }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width: 50%;">Contact Person Position</th>
                                                            <td style="width: 50%;">{{ $companyInfo->company_info_contact_person_position }}</td>
                                                        </tr>
                                        ...
                                        <div class="well well-sm">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <table style="width: 100%" class="table table-responsive">
                                                        <tr>
                                                            <th style="width: 40%;">About Company</th>
                                                            <td style="width: 60%;">{!! $companyInfo->company_info_description !!}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width: 40%;">Company Website</th>
                                                            <td style="width: 60%;">{{ $companyInfo->company_info_website }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width: 40%;">Phone No</th>
                                                            <td style="width: 60%;">{{ $companyInfo->company_info_phone }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width: 40%;">Logo</th>
                                                            <td style="width: 60%;">
                                                                <img style="width:120px" src="{{ isset($companyInfo->company_info_logo) ? URL::to('upload/frontend/company_info_logo/'.$companyInfo->company_info_logo) : URL::to('backend/images/default.png') }}" class="avatar img-thumbnail" alt="avatar">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
