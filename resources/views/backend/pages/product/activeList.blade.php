                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void0();" data-toggle="modal" data-target="#inactvate{{ $data->product_track_id }}">
                                                ...
                                                <div id="inactvate{{ $data->product_track_id }}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            <form method="POST" action="{{ URL::to('portal/product/inactivate') }}">
                                                                {{ csrf_field() }}
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-danger center-block"><i class="fa fa-trash"></i>&nbsp;Inactivate</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
