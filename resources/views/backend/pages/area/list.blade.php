            ...
            <div class="col-md-12">
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <div class="panel-heading panel-style">area List</div>
                                    ...
                                    <table id="tableList" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $data->area_status }}</td>                                              
                                                <td>
                                                    <a href="{{ url('portal/area/edit/'.$data->area_track_id) }}">
                                                        <button class="btn btn-default btn-sm"><i class="fa fa-edit"></i> Edit</button>
                                                    </a>&nbsp;
                                                    <a style="color: red;" href="javascript:void(0);" data-toggle="modal" data-target="#delete{{ $data->area_track_id }}">
                                                         <button class="btn btn-default btn-sm"><i class="fa fa-trash"></i>&nbsp;Delete</button>
                                                    </a>
                                                </td>
                                            </tr>
                                            <div id="delete{{ $data->area_track_id }}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            <form method="POST" action="{{ URL::to('portal/area/delete') }}">
                                                                {{ csrf_field() }}
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                    <h5 class="modal-title" style="color: red;">Are you sure?</h5>
                                                                    <input type="hidden" id="area_track_id" name="area_track_id" value="{{ $data->area_track_id }} " />
                                                                </div>
