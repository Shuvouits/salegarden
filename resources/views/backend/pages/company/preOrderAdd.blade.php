            ...
            <div class="col-md-12">
                <div class="panel-group">
                    <div class="panel panel-primary">
                        <div class="panel-heading panel-style">Add New Pre Order Product
                        </div>
                        <div class="clearfix"></div>
                        <form method="POST" enctype="multipart/form-data" action="{{ URL::to('portal/product/companyPreOrderStore') }}">
                            {{ csrf_field() }}
                            <div class="panel-body">
                                ...
                                <div class="panel panel-success" id="applicationHealthInf">
                                    <div class="panel-heading ucasSubPanelHeading" style="text-align: center;">Add New Pre Order Product</div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="product_order_date">Last Date To Order</label>
                                                        <input type="text" name="product_order_date" id="product_order_date" value="{{ old('product_order_date') }}" class="form-control date" />
                                                    </div>
                                                    <div class="form-group">
