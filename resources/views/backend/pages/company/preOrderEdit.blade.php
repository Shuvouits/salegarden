            ...
            <div class="col-md-12">
                <div class="panel-group">
                    <div class="panel panel-primary">
                        ...
                        <form id="target" method="POST" enctype="multipart/form-data" action="{{ URL::to('portal/product/companyPreOrderUpdate') }}">
                            {{ csrf_field() }}
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="product_order_date" id="product_order_date" value="{{ $dataList->product_order_date }}" class="form-control date" />
                                                    </div>
                                                    <div class="form-group">
