...
class PreOrderProductController extends Controller {
    ...
    public function showList() {
        $dataList = ProductModel::leftJoin('category', 'product.product_category_id', 'category.category_track_id')
                ...
                ->get();
        return view('backend.pages.company.preOrderList', compact('dataList'));
    }

    public function add() {
        $categoryList = CategoryModel::where('category_status', 'Active')->get();
        $brandList = BrandModel::where('brand_status', 'Active')->get();
        return view('backend.pages.company.preOrderAdd', compact('categoryList', 'brandList'));
    }
    ...
    public function store(Request $request) {
        ...
        $product_order_date = Input::get('product_order_date');
        ...
        if (count($errors) > 0) {
            ...
            $dataList->product_division = 'PreOrder';
            $dataList->product_order_date = $product_order_date;
            ...
            if ($dataList->save()) {
                ...
                return redirect('portal/product/companyPreOrderList')->with('success', 'Product successfully submitted');
            }
        }
    }
    ...
    public function edit($id) {
        ...
        $brandList = BrandModel::where('brand_status', 'Active')->get();
        return view('backend.pages.company.preOrderEdit', compact('dataList', 'categoryList', 'subCategoryList', 'brandList'));
    }
    ...
    public function update(Request $request) {
        ...
        if (count($errors) > 0) {
            ...
            $dataList->product_negotiable = $product_negotiable;
            if ($dataList->save()) {
                return redirect('portal/product/companyPreOrderList')->with('success', 'Product successfully updated');
            }
        }
    }
